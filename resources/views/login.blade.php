                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('loginProceso') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Recuerdame inicio de sesion</label>
                                            </div>
                                        </div>
